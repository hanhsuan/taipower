...
int test_time_of_use_option_core() {
  time_of_use_option_1_charge charge2 = {0};
  time_of_use_option_1_energy_consumption energy2 = {.peak = 2000,
  ...
  time_of_use_option_1_basic_info basic_info2 = {
  ...
  time_of_use_option_2_charge charge3 = {0};
  time_of_use_option_2_energy_consumption energy3 = {.peak = 81240,
  ...
  time_of_use_option_2_basic_info basic_info3 = {
      .customer_charge = 0,
  ...
  time_of_use_option_2_charge_calc(&charge3, energy3, basic_info3);
