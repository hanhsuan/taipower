...
int test_low_voltage_time_of_use_option_1() {
  time_of_use_option_1_charge device_charge = {0};
  time_of_use_option_1_energy_consumption device_ec = {
      .peak = 2000, .sat_partial_peak = 1000, .off_peak = 1500};
  low_voltage_time_of_use_option_1_basic_info device_info = {
  ...
  time_of_use_option_1_charge demand_charge = {0};
  time_of_use_option_1_energy_consumption demand_ec = {
      .peak = 6000, .sat_partial_peak = 1000, .off_peak = 4000};
  low_voltage_time_of_use_option_1_basic_info demand_info = {
  ...
  if (TAIPOWER_SUCC !=
      low_voltage_time_of_use_option_1_charge_calc(&device_charge, device_ec, device_info)) {
  ...
  if (TAIPOWER_SUCC !=
      low_voltage_time_of_use_option_1_charge_calc(&demand_charge, demand_ec, demand_info)) {
    return TAIPOWER_ERROR;
  }
