...
int test_high_voltage_time_of_use_option_2() {
  ...
  time_of_use_option_2_energy_consumption ec = {.peak = 10000,
                                         .partial_peak = 15000,
  ...
  time_of_use_option_2_charge charge2 = {0};
  time_of_use_option_2_energy_consumption ec2 = {.peak = 3000,
                                          .partial_peak = 22000,
                                          .sat_partial_peak = 5000,
                                          .off_peak = 20000};
  ...
  if (TAIPOWER_SUCC != high_voltage_time_of_use_option_2_charge_calc(&charge, ec, info) ||
      TAIPOWER_SUCC != high_voltage_time_of_use_option_2_charge_calc(&charge2, ec2, info2)) {
