...
int test_extra_high_voltage_time_of_use_option_2() {
  ...
  time_of_use_option_2_energy_consumption ec = {.peak = 100000,
                                         .partial_peak = 150000,
  ...
  time_of_use_option_2_energy_consumption ec2 = {.peak = 30000,
                                          .partial_peak = 220000,
                                          .sat_partial_peak = 50000,
                                          .off_peak = 200000};
  ...
  if (TAIPOWER_SUCC !=
          extra_high_voltage_time_of_use_option_2_charge_calc(&charge, ec, info) ||
      TAIPOWER_SUCC !=
          extra_high_voltage_time_of_use_option_2_charge_calc(&charge2, ec2, info2)) {
